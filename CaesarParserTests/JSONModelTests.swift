...
class JSONModelTests: XCTestCase {
    ...
    // Protocol extension can't define a default required init
    // Add final can make it work

//    class Person: JSONModel {
    final class Person: JSONModel {
        var name: String
        // Protocol extension default init can't init all stored properties
        // Add a default value to all properties to make it work
//        var name = ""
        var nickname: String?
        var age = 0
